...
namespace nicole {
     ...
     */
    extern const double kH2ColumnDensity[kNumberOfH2ShieldingFactors];

    /**
     * @brief Shielding factors θ[N(H2)] for H2 self-shielding.
     */
    extern const double kH2ShieldingFactors[kNumberOfH2ShieldingFactors];
     ...
     */
    extern const double kCOColumnDensity[kNumberOfCOShieldingFactors];

    /**
     * @brief Shielding factors θ[N(CO)] for CO self-shielding.
     */
    extern const double kCOShieldingFactors[kNumberOfCOShieldingFactors];
     ...
     */
    extern const double kH2ColumnDensityForCOShielding[kNumberOfH2ShieldingFactorsForCOShielding];

    /**
     * @brief Shielding factors θ2[N(H2)] for H2 contribution to CO shielding.
     */
    extern const double kH2ShieldingFactorsForCOShielding[kNumberOfH2ShieldingFactorsForCOShielding];
     ...
     */
    extern const double kVisualExtinctionForCOShielding[kNumberOfVisualExtinctionFactorsForCOShielding];

    /**
     * @brief Shielding factors θ3(Aν) for visual extinction contribution to CO shielding.
     */
    extern const double kVisualExtinctionFactorsForCOShielding[kNumberOfVisualExtinctionFactorsForCOShielding];

} // namespace nicole

#endif /* SELF_SHIELDING_DATA_HPP */